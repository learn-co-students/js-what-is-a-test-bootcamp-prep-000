...
This one has two `expect` statements. If you read them out as English you'll discover that the test expects `index.message` to include both `index.name` and `index.height`.
